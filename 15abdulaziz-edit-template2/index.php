...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Pendaftaran Mahasiswa</a>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="registrasi.php">Register</a>
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
                  ...
                  <tr>
                    <?php $nomer =1 ?>
                      ...
                      <tr>
                        ...
                        <td class="aksi2">
                          <a class="fas fa-fw fa-pencil-alt" href="ubah.php?id=<?= $row ["id"]; ?>" ></a> |
                          <a class="fas fa-fw fa-trash" href="hapus.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin');"></a>
                        </td>
          ...
          <div class="card-footer ">
                        ...
                        <a class="halaman" href="?halaman=<?= $halamanAktif -1 ;?>">Halaman Sebelumnya</a>
                        <?php endif;?>
                        ...
                        <a class="halaman" href="?halaman=<?= $halamanAktif +1 ;?>">Halaman Selanjutnya</a>
                        <?php endif;?>
          </div>
        </div>
